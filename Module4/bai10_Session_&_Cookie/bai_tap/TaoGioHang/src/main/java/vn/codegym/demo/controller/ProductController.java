...
import vn.codegym.demo.model.Cart;
...
public class ProductController {
    ...
    @GetMapping
    public String showList(@ModelAttribute("cart") Cart cart, Model model){
        model.addAttribute("products", productService.findAll());
        return "index";
    }

    @GetMapping("/detail")
    public String viewProductDetail(@RequestParam Integer id, Model model){
