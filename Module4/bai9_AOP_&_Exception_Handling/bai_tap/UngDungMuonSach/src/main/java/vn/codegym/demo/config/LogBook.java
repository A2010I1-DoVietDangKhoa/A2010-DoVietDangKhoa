...
public class LogBook {
    ...
    @AfterThrowing(pointcut = "execution(public * vn.codegym.demo.service.impl.BookService.*(..))", throwing = "e")
    ...
    @After(("execution(public * vn.codegym.demo.service.impl.BookService.*(..))"))
